        ...
        (async () => {
            try {
                ...
                const findLocation = (key) => {
                    const loc = locationsData.find(l => l.location_name === key)
                    return loc ? loc.location : ''
                }

                setVenueNames({
                    venue1: findLocation('echolounge'),
                    venue2: findLocation('houseofblue'),
                    venue3: findLocation('pavilion'),
                    venue4: findLocation('americanairlines')
                })
                setListeners()
            }
            catch (error) {
